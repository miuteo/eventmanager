...
class EventGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Event entity")
        ...
        .repeat(2) {
            ...
            .post("/api/events")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "date":"2020-01-01T00:00:00.000Z", "details":"SAMPLE_TEXT", "dateCreated":"2020-01-01T00:00:00.000Z", "lastUpdated":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))

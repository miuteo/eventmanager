(function() {
    ...
    CalendarDetailController.$inject = ['$scope', '$rootScope', '$stateParams', 'entity', 'Invitation', 'Event', 'User'];

    function CalendarDetailController($scope, $rootScope, $stateParams, entity, Invitation, Event, User) {
        var vm = this;
